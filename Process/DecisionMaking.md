...
| New API or Externally visible service or incompatible change  | Individual and Technical Lead of Owning Team | Architect is responsible for defining development criteria for new technology (eg readability, conventions, "hit by a bus factor")<br> Operations is responsible for defining operational criteria (eg expensive, high availability characteristics needed etc) <br> Engineering Management is responsible for defining SLA requirements  | Sony APIs and RSS Feeds |
